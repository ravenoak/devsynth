...
- [ ] Restore the missing requirements-wizard `features/general/*.feature` files and confirm the suites collect without `FileNotFoundError`.
- [ ] Reapply a single speed marker to each WSDE/UXBridge/UI integration test flagged by the 2025-10-07 collector warnings and rerun marker verification scripts.
