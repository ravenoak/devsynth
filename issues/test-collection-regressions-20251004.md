...
- 2025-10-20: Plugin registration is centralized in `tests.conftest`, behavior step markers sit below imports, and optional ONNX adapters now gate on `pytest.importorskip`; fresh `poetry run pytest --collect-only -q` and `poetry run pytest -k nothing --collect-only` transcripts confirm clean collection aside from expected optional dependency warnings.【F:tests/conftest.py†L28-L76】【F:tests/unit/application/memory/test_chromadb_store.py†L1-L32】【F:tests/behavior/steps/test_webui_integration_steps.py†L1-L69】【F:tests/unit/adapters/test_onnx_runtime_adapter.py†L1-L27】【F:diagnostics/testing/pytest_collect_only_20251020T172625Z.log†L1-L42】【F:diagnostics/testing/pytest_collect_only_k_nothing_20251020T172659Z.log†L1-L28】
