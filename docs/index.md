...
The [mkdocs.yml](../mkdocs.yml) file provides a navigable structure for all documentation. A [RepoStructure.md](RepoStructure.md) (planned) and autogenerated indices will provide a navigable map for both human and agentic contributors.
