...
- [FR-10a] The system shall read and interpret a `.devsynth/project.yaml` file to understand project structure, components, and custom layouts (e.g., monorepo, multi-language) as defined by the user.
