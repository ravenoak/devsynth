...
13.1.9 [x] Update behavior scenario loaders to reference the canonical `tests/behavior/features/general/...` paths so pytest-bdd can locate WebUI assets (Issue: [test-collection-regressions-20251004.md](../issues/test-collection-regressions-20251004.md)).【F:tests/behavior/test_webui_bridge.py†L1-L18】【F:tests/behavior/test_agent_api_interactions.py†L1-L10】【F:tests/behavior/steps/test_webui_inspect_config_steps.py†L1-L14】
