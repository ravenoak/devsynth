...
- BDD scenarios in [`tests/behavior/features/executive_summary.feature`](../../tests/behavior/features/executive_summary.feature) ensure termination and expected outcomes.
