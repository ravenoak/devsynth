...
The EDRR cycle implements a recursive, fractal structure where each macro phase contains its own nested micro-EDRR cycles:

### 4.4.1 Micro-EDRR within Macro-Expand

The Macro-Expand phase is executed through a nested micro-EDRR cycle:
...
The Macro-Differentiate phase is realized through its own internal micro-EDRR cycle:
...
The iterative Macro-Refine phase is manifested through its own internal micro-EDRR cycle:
...
class EDRRCoordinator:
    """Manages the execution of the EDRR cycle with recursive capabilities."""
    ...
    def execute_expand(self):
        ...
        # Create a micro-EDRR cycle for the Expand phase
    ...
    def execute_differentiate(self, expand_results):
        ...
        # Create a micro-EDRR cycle for the Differentiate phase
    ...
    def execute_refine(self, differentiate_results):
        ...
        # Create a micro-EDRR cycle for the Refine phase
    ...
    def execute_retrospect(self, refine_results):
        ...
        # Create a micro-EDRR cycle for the Retrospect phase
    ...
    def _create_micro_cycle(self, phase_type):
        """Create a micro-EDRR cycle coordinator for a specific phase."""
    ...
    def _should_terminate(self, results):
        """Determine if the EDRR cycle should terminate early."""
