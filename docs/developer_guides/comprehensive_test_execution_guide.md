...
- **run_all_tests.py**: Runs all tests or tests of a specific category and speed.
...
You can run tests by category and speed using the `run_all_tests.py` script:
...
1. **During Development**:
   ...
   - Use `python scripts/run_all_tests.py --fast`

2. **Before Committing**:
   - Run fast and medium tests to catch more issues
   - Use `python scripts/run_all_tests.py --fast --medium`
