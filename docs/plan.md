...
- Supporting specifications for the memory system and adapter read/write APIs still contain placeholder BDD assets (`[role]` scaffolding), so promotion is blocked pending executable scenarios.【F:docs/specifications/memory-and-context-system.md†L1-L36】【F:tests/behavior/features/memory_and_context_system.feature†L1-L25】【F:docs/specifications/memory-adapter-read-and-write-operations.md†L1-L43】【F:tests/behavior/features/memory_adapter_read_and_write_operations.feature†L1-L25】
