...
- **[EDRR Assessment](edrr_assessment.md)**: Assessment of the EDRR implementation.
...
- **[WSDE Validation](wsde_validation.md)**: Validation of the Worker Self-Directed Enterprise multi-agent collaboration model implementation.
...
- **[EDRR Framework](../architecture/edrr_framework.md)**: Documentation on the EDRR methodology architecture.
