...
1. **Time-Boxed Iterations**: Each EDRR cycle operates within a defined sprint duration (typically 1-2 weeks)
...
- `devsynth sprint start`: Begin a new EDRR cycle with planning
