...
def use_compatibility_utility(context, function_name, table):
    ...
    # Mock the utility function
    with patch.object(context.documentation_manager, 'get_api_compatibility', return_value=mock_results):
...
def use_usage_patterns_utility(context, function_name):
    ...
    # Mock the utility function
    with patch.object(context.documentation_manager, 'get_usage_patterns', return_value=mock_results):
