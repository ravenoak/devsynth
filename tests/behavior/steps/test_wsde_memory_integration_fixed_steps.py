...
def memory_system_with_multiple_backends(context):
    ...
    # For testing purposes, we'll use a simple dictionary of memory managers
    context.memory_managers = {
        backend_name: MemoryManager(adapter)
        for backend_name, adapter in context.memory_backends.items()
    }
