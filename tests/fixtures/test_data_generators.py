...
# ===== Code and Project Data Generators =====
...
def _create_project_files(base_dir: Union[str, Path], structure: Dict[str, Any]) -> None:
    """
...
def generate_test_project(project_id: Optional[str] = None, 
...
# ===== Fixtures for Domain-Specific Data =====
