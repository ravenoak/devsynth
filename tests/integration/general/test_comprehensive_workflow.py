    ...
    def sample_project(self):
        ...
        try:
            ...
            model_file = os.path.join(
                temp_dir, "src", "sample_app", "models", "user.py"
            )
...
"""
            ...
            view_file = os.path.join(
                temp_dir, "src", "sample_app", "views", "user_view.py"
            )
...
"""
            ...
            controller_file = os.path.join(
                temp_dir, "src", "sample_app", "controllers", "user_controller.py"
            )
...
"""
    ...
    def test_end_to_end_workflow_succeeds(self, sample_project):
        ...
        assert entry_point is not None
        assert (
            project_state["architecture"]["type"]
            == code_analysis["insights"]["architecture"]["type"]
        )
