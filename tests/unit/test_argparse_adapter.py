...
from devsynth.adapters.cli.argparse_adapter import parse_args, run_cli, show_help


class TestArgparseAdapter:
    """Tests for the argparse CLI adapter."""
    ...
    @patch("devsynth.adapters.cli.argparse_adapter.init_cmd")
    ...
    @patch("devsynth.adapters.cli.argparse_adapter.spec_cmd")
    ...
    @patch("devsynth.adapters.cli.argparse_adapter.test_cmd")
    ...
    @patch("devsynth.adapters.cli.argparse_adapter.code_cmd")
    ...
    @patch("devsynth.adapters.cli.argparse_adapter.run_cmd")
    ...
    @patch("devsynth.adapters.cli.argparse_adapter.config_cmd")
    ...
    @patch("devsynth.adapters.cli.argparse_adapter.show_help")
