...
try:
    from devsynth.application.memory import InMemoryStore, SimpleContextManager, JSONFileStore, PersistentContextManager
...
ReqID: N/A"""
        item = MemoryItem(id='', content='Test content', memory_type=
            MemoryType.SHORT_TERM, metadata={'key': 'value'})
...
ReqID: N/A"""
        item1 = MemoryItem(id='', content='Apple content', memory_type=
            MemoryType.SHORT_TERM, metadata={'fruit': 'apple'})
        item2 = MemoryItem(id='', content='Banana content', memory_type=
            MemoryType.LONG_TERM, metadata={'fruit': 'banana'})
...
ReqID: N/A"""
        item = MemoryItem(id='', content='Persistent content', memory_type=
...
ReqID: N/A"""
        ...
        self.assertIsInstance(adapter.get_context_manager(),
...
ReqID: N/A"""
        adapter = MemorySystemAdapter({'memory_store_type': 'file',
...
ReqID: N/A"""
        ...
        self.assertGreater(updated_usage['total_tokens'], initial_usage[
            'total_tokens'])
