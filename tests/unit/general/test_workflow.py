...
class TestWorkflowManager:
    ...
    def test_create_workflow_for_command_succeeds(self, workflow_manager):
        ...
        for command in commands:
            result = workflow_manager._create_workflow_for_command(
                command, {"test": "value"}
            )
    ...
    def test_execute_command_human_intervention_succeeds(self, workflow_manager):
        ...
        workflow_manager._handle_human_intervention = MagicMock(
            return_value="User input"
        )
        result = workflow_manager.execute_command("init", {"path": "./test-project"})
