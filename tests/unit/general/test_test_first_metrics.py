...
class TestTestFirstMetrics(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_commits = [
            ...
            },
            {
                ...
                "files": [{"path": "src/devsynth/no_test.py", "status": "A"}],
            },
        ]
    ...
    def test_analyze_commit_succeeds(self, mock_run):
        ...
        mock_process = MagicMock()
        mock_process.stdout = "\n".join(
            ["M\tsrc/devsynth/feature.py", "A\ttests/unit/test_feature.py"]
        )
        mock_run.return_value = mock_process
        commit = {
            "hash": "abc123",
    ...
    def test_calculate_metrics_succeeds(self):
        ...
        self.assertEqual(
            metrics["by_author"]["Test Author"]["implementation_first_commits"], 1
        )
        self.assertAlmostEqual(
            metrics["by_author"]["Test Author"]["test_first_percentage"],
            66.67,
            places=2,
        )
        ...
        self.assertEqual(
            metrics["by_date"]["2025-05-25"]["implementation_first_commits"], 0
        )
        self.assertEqual(
