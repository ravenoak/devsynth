...
def test_html_generation():
    ...
    metrics = {
        "overall_score": 82.5,
        "coverage": {"line_coverage": 85.0, "covered_lines": 850, "num_statements": 1000},
        "mutation": {"skipped": False, "mutation_score": 75.0, "killed_mutations": 18, "total_mutations": 24},
        "property": {"total_property_tests": 12, "property_test_files": 4, "enabled": True},
        "organization": {"marker_compliance": 95.0, "total_tests": 500},
        "performance": {"parallel_speedup": 4.2, "worker_count": 8, "efficiency": 0.525},
