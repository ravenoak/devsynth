...
from devsynth.domain.models.wsde import WSDE, WSDATeam
from devsynth.domain.models.agent import AgentType, AgentConfig
from devsynth.application.agents.unified_agent import UnifiedAgent
from devsynth.adapters.agents.agent_adapter import SimplifiedAgentFactory, WSDATeamCoordinator, AgentAdapter
...
class TestAgentCollaboration:
    ...
    def coordinator(self, mock_agent):
        ...
        coordinator = WSDATeamCoordinator()
