import pytest
from devsynth.security.validation import validate_non_empty, validate_int_range, validate_choice
...
ReqID: N/A"""
    ...
    @pytest.mark.parametrize('value,expected', [('5', 5), (5, 5), ('10', 10
        ), ('-5', -5), ('0', 0)])
...
ReqID: N/A"""
    ...
    @pytest.mark.parametrize('value,min_val,max_val,expected', [('5', 1, 10,
        5), ('1', 1, 10, 1), ('10', 1, 10, 10), ('-5', -10, 0, -5), ('0', -
        10, 10, 0)])
    def test_valid_int_with_range_is_valid(self, value, min_val, max_val,
        expected):
        """Test with valid integer values within range.

ReqID: N/A"""
        assert validate_int_range(value, 'num', min_value=min_val,
            max_value=max_val) == expected
...
ReqID: N/A"""
    ...
    @pytest.mark.parametrize('value,max_val', [('10', 5), ('0', -1), ('100',
        99)])
...
ReqID: N/A"""
    ...
    @pytest.mark.parametrize('value,choices', [('a', ['a', 'b', 'c']), (1,
        [1, 2, 3]), (True, [True, False]), (None, [None, 'value']), (
        'value', {'value', 'other'}), (5, (5, 10, 15))])
...
ReqID: N/A"""
    ...
    @pytest.mark.parametrize('value,choices', [('d', ['a', 'b', 'c']), (4,
        [1, 2, 3]), (None, [True, False]), ('missing', {'value', 'other'}),
        (20, (5, 10, 15))])
...
ReqID: N/A"""
        ...
        assert set(excinfo.value.details['constraints']['choices']) == set(
            choices)
