...
class SimpleAgent:
    ...
    def __init__(
        self, name, expertise=None, experience_level=None, performance_history=None
    ):
        self.name = name
...
class TestEnhancedExpertiseScoring:
    ...
    def setup_method(self):
        ...
        self.team.add_agents(
            [self.python_agent, self.doc_agent, self.test_agent, self.security_agent]
        )

    @pytest.mark.medium
    def test_enhanced_calculate_expertise_score_exact_match_matches_expected(self):
        ...
        assert score > 0
        assert score > self.team.enhanced_calculate_expertise_score(
            self.doc_agent, task
        )

    @pytest.mark.medium
    def test_enhanced_calculate_expertise_score_partial_match_matches_expected(self):
    ...
    @pytest.mark.medium
    def test_enhanced_calculate_expertise_score_performance_history_succeeds(self):
...
class TestEnhancedPrimusSelection:
    ...
    def setup_method(self):
        ...
        self.test_agent = SimpleAgent(
            name="tester", expertise=["testing", "test_automation", "quality_assurance"]
        )
        self.security_agent = SimpleAgent(
            name="security_expert",
            expertise=["security", "authentication", "encryption"],
