...
class TestLMStudioProviderInitialization:
    ...
    def test_initialization_with_auto_model_selection(self):
        ...
        config = {"base_url": "http://localhost:1234/v1", "auto_select_model": True}
    ...
    def test_initialization_with_custom_port(self):
        ...
        config = {"base_url": "http://localhost:8080/v1", "model": "custom-model"}
    ...
    def test_initialization_lmstudio_unavailable(self):
        ...
        with patch(
            ...
            mock_require.side_effect = DevSynthError(
                "LMStudio support requires the 'lmstudio' package"
            )
...
class TestLMStudioProviderTokenTracking:
    ...
    def test_token_limit_validation(self):
        ...
        config = {"base_url": "http://localhost:1234/v1", "max_tokens": 10}
...
class TestLMStudioProviderErrorHandling:
    ...
    def test_invalid_model_error_handling(self):
        ...
        with patch(
            ...
            mock_lmstudio.sync_api.chat.completions.create.side_effect = Exception(
                "Invalid model"
            )
