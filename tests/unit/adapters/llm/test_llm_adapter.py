...
ReqID: N/A"""
    ...
    class TestLLMBackendAdapter(LLMBackendAdapter):
...
def test_integration_with_openai_provider_has_expected(mock_provider_class, mock_factory):
...
@pytest.mark.medium
def test_integration_with_anthropic_provider_has_expected(mock_provider_class, mock_factory):
