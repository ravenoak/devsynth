...
ReqID: N/A"""
    ...
    def mock_llm_port(self):
        ...
        mock_port.generate_with_context.return_value = (
            'Generated documentation with context')
        return mock_port
    ...
    def documentation_agent(self, mock_llm_port):
        ...
        config = AgentConfig(name='TestDocumentationAgent', agent_type=
            AgentType.DOCUMENTATION, description='Test Documentation Agent',
            capabilities=[])
...
ReqID: N/A"""
        with patch.object(documentation_agent, 'create_wsde', side_effect=
