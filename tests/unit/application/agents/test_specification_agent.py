...
class TestSpecificationAgent:
    ...
    def specification_agent(self, mock_llm_port):
        ...
        config = AgentConfig(name='TestSpecificationAgent', agent_type=AgentType.SPECIFICATION, description='Test Specification Agent', capabilities=[])
    ...
    def test_get_capabilities_with_custom_capabilities_succeeds(self):
        agent = SpecificationAgent()
        config = AgentConfig(name='TestSpecificationAgent', agent_type=AgentType.SPECIFICATION, description='Test', capabilities=['custom'])
        agent.initialize(config)
