...
class TestValidationAgent:
    ...
    def validation_agent(self, mock_llm_port):
        ...
        config = AgentConfig(name='TestValidationAgent', agent_type=AgentType.VALIDATION, description='Test Validation Agent', capabilities=[])
    ...
    def test_process_succeeds(self, validation_agent):
        inputs = {'context': 'ctx', 'specifications': 'spec', 'tests': 'tests', 'code': 'code'}
