...
ReqID: N/A"""
    ...
    def test_process_task_non_hierarchical_succeeds(self,
...
ReqID: N/A"""
        ...
        task = {'id': 'task1', 'type': 'implementation_task', 'title':
            'Implement a feature', 'description': 'Implement a feature',
        ...
        team.contribution_metrics['task1']['Agent1'] = {'assigned_subtasks':
            2, 'completed_subtasks': 1, 'total_progress': 1.5,
            'average_progress': 0.75}
        team.contribution_metrics['task1']['Agent3'] = {'assigned_subtasks':
            1, 'completed_subtasks': 0, 'total_progress': 0.5,
...
ReqID: N/A"""
        ...
        team.add_agent(agent2)
        team.add_agent(agent3)
        task = {'id': 'task2', 'type': 'implementation_task', 'title':
            'Implement a feature', 'description': 'Implement a feature',
            'required_expertise': ['python', 'security']}
        result = team.process_task(task)
        ...
        team.contribution_metrics['task2']['Agent1'] = {'assigned_subtasks':
            3, 'completed_subtasks': 2, 'total_progress': 2.5,
            'average_progress': 0.83}
        team.contribution_metrics['task2']['Agent2'] = {'assigned_subtasks':
            1, 'completed_subtasks': 0, 'total_progress': 0.3,
            'average_progress': 0.3}
        team.contribution_metrics['task2']['Agent3'] = {'assigned_subtasks':
            1, 'completed_subtasks': 0, 'total_progress': 0.2,
...
ReqID: N/A"""
        ...
        team.add_agent(agent1)
        team.add_agent(agent2)
        task = {'id': 'task3', 'type': 'implementation_task', 'title':
            'Implement a feature', 'description': 'Implement a feature'}
        ...
        if metrics:
            for agent_name in metrics:
                ...
                assert 'total_progress' in metrics[agent_name]
                assert 'average_progress' in metrics[agent_name]
        non_existent_metrics = team.get_contribution_metrics(
            'non_existent_task')
...
ReqID: N/A"""
        ...
        team.add_agent(agent1)
        team.add_agent(agent2)
        task1 = {'id': 'task4', 'type': 'implementation_task', 'title':
            'Implement feature 1', 'description': 'Implement feature 1'}
        task2 = {'id': 'task5', 'type': 'implementation_task', 'title':
            'Implement feature 2', 'description': 'Implement feature 2'}
...
ReqID: N/A"""
        team = CollaborativeWSDETeam(name='TestTeam')
        main_task = {'id': 'main_task', 'type': 'implementation_task',
            'title': 'Implement a feature', 'description':
            'Implement a feature'}
        subtasks = [{'id': 'subtask1', 'description': 'Implement backend',
            'primary_expertise': 'python'}, {'id': 'subtask2',
            'description': 'Implement frontend', 'primary_expertise':
            'javascript'}]
...
ReqID: N/A"""
        ...
        team.add_agent(agent2)
        team.add_agent(agent3)
        subtasks = [{'id': 'subtask1', 'title': 'Implement backend',
            'description': 'Implement backend', 'primary_expertise':
            'python', 'status': 'pending'}, {'id': 'subtask2', 'title':
            'Implement frontend', 'description': 'Implement frontend',
            'primary_expertise': 'javascript', 'status': 'pending'}, {'id':
            'subtask3', 'title': 'Security review', 'description':
            'Security review', 'primary_expertise': 'security', 'status':
            'pending'}]
...
ReqID: N/A"""
        team = CollaborativeWSDETeam(name='TestTeam')
        subtask = {'id': 'subtask1', 'title': 'Implement backend',
            'description': 'Implement backend', 'primary_expertise':
    ...
    def test_reassign_subtasks_based_on_progress_succeeds(self,
        mock_agent_with_expertise):
...
ReqID: N/A"""
        ...
        team.add_agent(agent2)
        team.add_agent(agent3)
        subtasks = [{'id': 'subtask1', 'title': 'Implement backend 1',
            'description': 'Implement backend 1', 'primary_expertise':
            'python', 'status': 'assigned'}, {'id': 'subtask2', 'title':
            'Implement backend 2', 'description': 'Implement backend 2',
            'primary_expertise': 'python', 'status': 'assigned'}, {'id':
            'subtask3', 'title': 'Implement frontend', 'description':
            'Implement frontend', 'primary_expertise': 'javascript',
            'status': 'assigned'}]
        team.subtask_assignments = {'subtask1': 'Agent1', 'subtask2':
            'Agent1', 'subtask3': 'Agent2'}
        team.subtask_progress = {'subtask1': 0.7, 'subtask2': 0.2,
            'subtask3': 0.5}
        reassignment_results = team.reassign_subtasks_based_on_progress(
            subtasks)
