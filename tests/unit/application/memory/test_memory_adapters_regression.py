...
def test_store_retrieve_search_update(adapter_cls, tmp_path):
    ...
    item = MemoryItem(id='', content={'foo': 'bar'}, memory_type=MemoryType.KNOWLEDGE, metadata={'tag': 't'})
...
def test_vector_adapter_operations():
    ...
    vector = MemoryVector(id='', content='doc', embedding=[0.1, 0.2, 0.3], metadata={'kind': 'test'})
...
def test_tinydb_adapter_transaction_support(tmp_path):
    ...
    item1 = MemoryItem(id='test1', content='Test content 1', memory_type=MemoryType.KNOWLEDGE, metadata={'tag': 'transaction_test'})
    item2 = MemoryItem(id='test2', content='Test content 2', memory_type=MemoryType.KNOWLEDGE, metadata={'tag': 'transaction_test'})
    ...
    item3 = MemoryItem(id='test3', content='Test content 3', memory_type=MemoryType.KNOWLEDGE, metadata={'tag': 'transaction_test'})
