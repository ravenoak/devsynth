...
class TestManifestParser:
    ...
    def test_parse_file_valid_is_valid(self, manifest_parser, manifest_file):
        ...
        assert (
            manifest["phases"]["expand"]["instructions"] == "Expand phase instructions"
        )
    ...
    @pytest.mark.medium
    def test_validate_valid_is_valid(
        self, mock_validate, manifest_parser, valid_manifest
    ):
        ...
        mock_validate.assert_called_once_with(
            instance=valid_manifest, schema=MANIFEST_SCHEMA
        )
    ...
    @pytest.mark.medium
    def test_get_phase_instructions_phase_not_found_has_expected(
        self, manifest_parser_with_manifest
    ):
    ...
    @pytest.mark.medium
    def test_get_phase_templates_phase_not_found_has_expected(
        self, manifest_parser_with_manifest
    ):
    ...
    @pytest.mark.medium
    def test_get_phase_resources_phase_not_found_has_expected(
        self, manifest_parser_with_manifest
    ):
    ...
    @pytest.mark.medium
    def test_get_manifest_metadata_no_metadata_succeeds(
        self, manifest_parser_with_manifest
    ):
    ...
    def test_start_execution_succeeds(self, manifest_parser_with_manifest):
        ...
        assert (
            manifest_parser_with_manifest.execution_trace["manifest_id"]
            == "test-manifest"
        )
        ...
        for phase in Phase:
            ...
            assert (
                manifest_parser_with_manifest.phase_status[phase]["status"] == "pending"
            )
            assert (
                manifest_parser_with_manifest.phase_status[phase]["start_time"] is None
            )
            ...
            if phase not in manifest_parser_with_manifest.phase_dependencies:
                assert (
                    manifest_parser_with_manifest.phase_status[phase][
                        "dependencies_met"
                    ]
                    is True
                )
    ...
    def test_check_phase_dependencies_has_expected(self, manifest_parser_with_manifest):
        ...
        manifest_parser_with_manifest.start_execution()
        assert (
            manifest_parser_with_manifest.check_phase_dependencies(Phase.EXPAND) is True
        )
        assert (
            manifest_parser_with_manifest.check_phase_dependencies(Phase.DIFFERENTIATE)
            is False
        )
    ...
    def test_start_phase_has_expected(self, manifest_parser_with_manifest):
        ...
        assert (
            manifest_parser_with_manifest.phase_status[Phase.EXPAND]["start_time"]
            is not None
        )
        assert (
            manifest_parser_with_manifest.phase_status[Phase.EXPAND]["dependencies_met"]
            is True
        )
        assert (
            manifest_parser_with_manifest.execution_trace["phases"]["expand"]["status"]
            == "in_progress"
        )
        assert (
            manifest_parser_with_manifest.execution_trace["phases"]["expand"][
                "start_time"
            ]
            is not None
        )
    ...
    @pytest.mark.medium
    def test_start_phase_dependencies_not_met_has_expected(
        self, manifest_parser_with_manifest
    ):
    ...
    def test_complete_phase_has_expected(self, manifest_parser_with_manifest):
        ...
        assert (
            manifest_parser_with_manifest.phase_status[Phase.EXPAND]["end_time"]
            is not None
        )
        assert (
            manifest_parser_with_manifest.phase_status[Phase.EXPAND]["duration"]
            is not None
        )
        assert (
            manifest_parser_with_manifest.phase_status[Phase.EXPAND]["result"] == result
        )
        assert (
            manifest_parser_with_manifest.execution_trace["phases"]["expand"]["status"]
            == "completed"
        ...
        assert (
            manifest_parser_with_manifest.execution_trace["phases"]["expand"]["result"]
            == result
        )
        assert (
            manifest_parser_with_manifest.phase_status[Phase.DIFFERENTIATE][
                "dependencies_met"
            ]
            is True
        )
    ...
    @pytest.mark.medium
    def test_complete_phase_not_in_progress_has_expected(
        self, manifest_parser_with_manifest
    ):
    ...
    @pytest.mark.medium
    def test_complete_execution_not_all_phases_completed_has_expected(
        self, manifest_parser_with_manifest
    ):
    ...
    @pytest.mark.medium
    def test_get_phase_status_unknown_phase_has_expected(
        self, manifest_parser_with_manifest
    ):
