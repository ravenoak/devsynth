...
def valid_manifest():
    ...
    return {'id': 'test-manifest', 'description':
        'Test manifest for unit tests', 'metadata': {'version': '1.0',
        'author': 'Test Author'}, 'phases': {'expand': {'instructions':
        'Expand phase instructions', 'templates': ['template1', 'template2'
        ], 'resources': ['resource1', 'resource2']}, 'differentiate': {
        'instructions': 'Differentiate phase instructions', 'templates': [
        'template3'], 'resources': ['resource3']}, 'refine': {
        'instructions': 'Refine phase instructions', 'templates': [
        'template4'], 'resources': ['resource4']}, 'retrospect': {
        'instructions': 'Retrospect phase instructions', 'templates': [
        'template5'], 'resources': ['resource5']}}}
...
ReqID: N/A"""
        ...
        assert parser.phase_dependencies == {Phase.DIFFERENTIATE: {Phase.
            EXPAND}, Phase.REFINE: {Phase.DIFFERENTIATE}, Phase.RETROSPECT:
            {Phase.REFINE}}
...
ReqID: N/A"""
        ...
        assert manifest['phases']['expand']['instructions'
            ] == 'Expand phase instructions'
...
ReqID: N/A"""
    ...
    def test_validate_valid_is_valid(self, mock_validate, manifest_parser,
        valid_manifest):
        """Test validating a valid manifest.

ReqID: N/A"""
        manifest_parser.validate(valid_manifest)
        mock_validate.assert_called_once_with(instance=valid_manifest,
...
ReqID: N/A"""
    ...
    def test_get_phase_instructions_has_expected(self,
        manifest_parser_with_manifest):
        """Test getting phase instructions.

ReqID: N/A"""
        instructions = manifest_parser_with_manifest.get_phase_instructions(
            Phase.EXPAND)
        assert instructions == 'Expand phase instructions'

    def test_get_phase_instructions_no_manifest_has_expected(self,
        manifest_parser):
...
ReqID: N/A"""
    ...
    def test_get_phase_instructions_phase_not_found_has_expected(self,
        manifest_parser_with_manifest):
...
ReqID: N/A"""
    ...
    def test_get_phase_templates_has_expected(self,
        manifest_parser_with_manifest):
        """Test getting phase templates.

ReqID: N/A"""
        templates = manifest_parser_with_manifest.get_phase_templates(Phase
            .EXPAND)
...
ReqID: N/A"""
    ...
    def test_get_phase_templates_phase_not_found_has_expected(self,
        manifest_parser_with_manifest):
...
ReqID: N/A"""
    ...
    def test_get_phase_resources_has_expected(self,
        manifest_parser_with_manifest):
        """Test getting phase resources.

ReqID: N/A"""
        resources = manifest_parser_with_manifest.get_phase_resources(Phase
            .EXPAND)
...
ReqID: N/A"""
    ...
    def test_get_phase_resources_phase_not_found_has_expected(self,
        manifest_parser_with_manifest):
...
ReqID: N/A"""
    ...
    def test_get_manifest_description_succeeds(self,
        manifest_parser_with_manifest):
...
ReqID: N/A"""
    ...
    def test_get_manifest_description_no_manifest_succeeds(self,
        manifest_parser):
...
ReqID: N/A"""
    ...
    def test_get_manifest_metadata_no_metadata_succeeds(self,
        manifest_parser_with_manifest):
...
ReqID: N/A"""
        ...
        assert manifest_parser_with_manifest.execution_trace['manifest_id'
            ] == 'test-manifest'
        assert 'start_time' in manifest_parser_with_manifest.execution_trace
        assert manifest_parser_with_manifest.execution_trace['completed'
            ] is False
        assert 'phases' in manifest_parser_with_manifest.execution_trace
        for phase in Phase:
            assert phase in manifest_parser_with_manifest.phase_status
            assert manifest_parser_with_manifest.phase_status[phase]['status'
                ] == 'pending'
            assert manifest_parser_with_manifest.phase_status[phase][
                'start_time'] is None
            assert manifest_parser_with_manifest.phase_status[phase]['end_time'
                ] is None
            assert manifest_parser_with_manifest.phase_status[phase]['duration'
                ] is None
            if phase not in manifest_parser_with_manifest.phase_dependencies:
                assert manifest_parser_with_manifest.phase_status[phase][
                    'dependencies_met'] is True
            else:
                assert manifest_parser_with_manifest.phase_status[phase][
                    'dependencies_met'] is False
...
ReqID: N/A"""
    ...
    def test_check_phase_dependencies_has_expected(self,
        manifest_parser_with_manifest):
        """Test checking phase dependencies.

ReqID: N/A"""
        manifest_parser_with_manifest.start_execution()
        assert manifest_parser_with_manifest.check_phase_dependencies(Phase
            .EXPAND) is True
        assert manifest_parser_with_manifest.check_phase_dependencies(Phase
            .DIFFERENTIATE) is False
        manifest_parser_with_manifest.phase_status[Phase.EXPAND]['status'
            ] = 'completed'
        assert manifest_parser_with_manifest.check_phase_dependencies(Phase
            .DIFFERENTIATE) is True

    def test_check_phase_dependencies_no_manifest_has_expected(self,
        manifest_parser):
...
ReqID: N/A"""
        ...
        assert manifest_parser_with_manifest.phase_status[Phase.EXPAND][
            'status'] == 'in_progress'
        assert manifest_parser_with_manifest.phase_status[Phase.EXPAND][
            'start_time'] is not None
        assert manifest_parser_with_manifest.phase_status[Phase.EXPAND][
            'dependencies_met'] is True
        assert manifest_parser_with_manifest.execution_trace['phases']['expand'
            ]['status'] == 'in_progress'
        assert manifest_parser_with_manifest.execution_trace['phases']['expand'
            ]['start_time'] is not None
...
ReqID: N/A"""
    ...
    def test_start_phase_dependencies_not_met_has_expected(self,
        manifest_parser_with_manifest):
...
ReqID: N/A"""
        ...
        assert manifest_parser_with_manifest.phase_status[Phase.DIFFERENTIATE][
            'dependencies_met'] is True
...
ReqID: N/A"""
    ...
    def test_complete_phase_not_in_progress_has_expected(self,
        manifest_parser_with_manifest):
...
ReqID: N/A"""
    ...
    def test_complete_execution_not_all_phases_completed_has_expected(self,
        manifest_parser_with_manifest):
...
ReqID: N/A"""
    ...
    def test_get_phase_status_unknown_phase_has_expected(self,
        manifest_parser_with_manifest):
