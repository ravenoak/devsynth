...
ReqID: N/A"""
    ...
    def mock_embed(self):
        with patch('devsynth.adapters.kuzu_memory_store.embed',
...
ReqID: N/A"""
        memory_item = MemoryItem(id='test-item', content=
        ...
        vector = MemoryVector(id='test-vector', content=
            'This is a test vector', embedding=[0.1, 0.2, 0.3], metadata={
