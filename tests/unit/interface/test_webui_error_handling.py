...
def test_init_cmd_error_handling(stub_streamlit, monkeypatch, clean_state):
    ...
    assert any(
        "ERROR" in call[0][0] and "Test init error" in call[0][0]
...
@pytest.mark.medium
def test_onboarding_page_setup_wizard_error_raises_error(stub_streamlit, monkeypatch):
    ...
    # Verify that display_result was called with the error message
    assert any(
        "ERROR" in call[0][0] and "Test setup error" in call[0][0]
        for call in webui_instance.display_result.call_args_list
    )
...
@pytest.mark.medium
def test_requirements_page_spec_cmd_error_raises_error(stub_streamlit, monkeypatch):
    ...
    # Verify that display_result was called with the error message
    assert any(
        "ERROR" in call[0][0] and "Test spec error" in call[0][0]
        for call in webui_instance.display_result.call_args_list
    )
...
@pytest.mark.medium
def test_requirements_page_inspect_cmd_error_raises_error(stub_streamlit, monkeypatch):
    ...
    # Verify that display_result was called with the error message
    assert any(
        "ERROR" in call[0][0] and "Test inspect error" in call[0][0]
        for call in webui_instance.display_result.call_args_list
    )
...
@pytest.mark.medium
def test_requirements_page_file_not_found_raises_error(stub_streamlit, monkeypatch):
...
@pytest.mark.medium
def test_analysis_page_inspect_code_cmd_error_raises_error(stub_streamlit, monkeypatch):
    ...
    # Verify that display_result was called with the error message
    assert any(
        "ERROR" in call[0][0] and "Test inspect code error" in call[0][0]
        for call in webui_instance.display_result.call_args_list
    )
...
def test_synthesis_page_test_cmd_error_raises_error(stub_streamlit, monkeypatch):
    ...
    # Verify that display_result was called with the error message
    assert any(
        "ERROR" in call[0][0] and "Test test_cmd error" in call[0][0]
        for call in webui_instance.display_result.call_args_list
    )
