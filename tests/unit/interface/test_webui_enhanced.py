...
def test_webui_display_result_highlight(mock_streamlit):
...
def test_webui_display_result_error(mock_streamlit):
...
def test_webui_display_result_warning(mock_streamlit):
...
def test_webui_display_result_success(mock_streamlit):
...
def test_webui_display_result_heading(mock_streamlit):
...
def test_webui_display_result_subheading(mock_streamlit):
...
def test_webui_display_result_rich_markup(mock_streamlit):
    ...
    mock_streamlit.markdown.assert_called_once_with("**Bold text**", unsafe_allow_html=True)


def test_webui_display_result_normal(mock_streamlit):
...
def test_webui_progress_indicator(mock_streamlit):
    ...
    # Test that the progress indicator is created with the correct description
    ...
    # Test update_subtask method
    progress.update_subtask(subtask_id, 25, "Updated subtask")
    
    # Test complete_subtask method
