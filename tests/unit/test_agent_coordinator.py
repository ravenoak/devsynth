...
from devsynth.application.collaboration.exceptions import CollaborationError, AgentExecutionError, ConsensusError, RoleAssignmentError, TeamConfigurationError
