...
ReqID: N/A"""
        step = WorkflowStep(id='step-1', name='Analyze Requirements',
            description='Analyze project requirements', agent_type='planner')
...
ReqID: N/A"""
        step1 = WorkflowStep(id='step-1', name='Analyze Requirements',
            description='Analyze project requirements', agent_type='planner')
        step2 = WorkflowStep(id='step-2', name='Generate Tests',
            description='Generate test cases', agent_type='tester')
        workflow = Workflow(id='workflow-1', name='Test Workflow',
            description='A test workflow', steps=[step1, step2], status=
