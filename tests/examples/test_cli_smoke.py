...
@pytest.mark.fast
def test_doctor_cli_quick_smoke(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
...
@pytest.mark.fast
def test_run_tests_cli_inventory_smoke(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
