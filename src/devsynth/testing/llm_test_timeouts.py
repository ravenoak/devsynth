...
class LLMTestTimeouts:
    ...
    def from_environment(cls) -> "LLMTestTimeouts":
        ...
        return cls(
            lmstudio_small=float(os.getenv("DEVSYNTH_TEST_TIMEOUT_LMSTUDIO_SMALL", 20.0)),
            lmstudio_medium=float(os.getenv("DEVSYNTH_TEST_TIMEOUT_LMSTUDIO_MEDIUM", 30.0)),
            lmstudio_large=float(os.getenv("DEVSYNTH_TEST_TIMEOUT_LMSTUDIO_LARGE", 60.0)),
            lmstudio_health=float(os.getenv("DEVSYNTH_TEST_TIMEOUT_LMSTUDIO_HEALTH", 10.0)),
