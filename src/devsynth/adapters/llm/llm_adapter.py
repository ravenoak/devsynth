...
from ...application.llm.providers import factory, SimpleLLMProviderFactory, OpenAIProvider, AnthropicProvider
...
class LLMBackendAdapter:
    ...
    def __init__(self):
        # Use the global factory instance that already has providers registered
