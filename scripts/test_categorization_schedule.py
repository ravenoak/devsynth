        ...
        with open(file_path, 'r') as f:
            ...
            if test_def in content:
                ...
                if test_pos > 0:
                    ...
                    if '@pytest.mark.fast' in test_context or '@pytest.mark.medium' in test_context or '@pytest.mark.slow' in test_context:
                        categorized_count += 1
...
def main() -> None:
    ...
    if args.generate_schedule:
        ...
        print("No action specified. Use --generate-schedule, --update-progress, --run-scheduled, or --list-schedule.")
