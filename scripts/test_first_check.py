...
def check_test_files_exist(expected_test_files: List[str], staged_files: List[str]) -> Tuple[bool, List[str]]:
...
def main(filenames: List[str]) -> int:
    ...
    tests_exist, missing_tests = check_test_files_exist(expected_test_files, staged_files)
