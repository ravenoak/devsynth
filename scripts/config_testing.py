    ...
    def test_different_test_frameworks(self):
        ...
        for language, frameworks in test_frameworks.items():
            for framework in frameworks:
                ...
                project_dir = self.create_project(f"test_framework_{language}_{framework}")
                config = {
                    "language": language,
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test DevSynth with different configuration options")
    parser.add_argument(
        "--output",
