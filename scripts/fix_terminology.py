        ...
        for variation in variations:
            ...
            if variation.lower() != preferred_form.lower():
                ...
                for match in reversed(matches):
                    ...
                    found = match.group(0)
                    content = content[:match.start()] + preferred_form + content[match.end():]
    ...
    for term, correct_capitalization in CAPITALIZATION_RULES.items():
        ...
        for match in reversed(matches):
            ...
            if found != correct_capitalization:
                ...
                content = content[:match.start()] + correct_capitalization + content[match.end():]
                changes.append(f"Fixed capitalization: '{found}' -> '{correct_capitalization}'")
