...
def run_functional_tests() -> Tuple[bool, List[str]]:
    ...
    try:
        ...
        try:
            ...
            issues.append(f"✅ Analytics system active: {analytics['recent_activity']['rule_events']} events")
        except Exception:
...
def main():
    ...
    if all_passed:
        ...
        print("   4. Analyze: Run python .cursor/hooks/self_improvement_orchestrator.py --dashboard")
        return 0
    else:
